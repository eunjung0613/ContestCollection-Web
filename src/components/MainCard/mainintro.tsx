    ...
    <div>
      <div css={mainwrap}>
        ...
        <div css={maintext}>
          <div>
            <h4 css={mainh}>
              <span css={mainh2}>S-CON이란?</span>
            </h4>
          </div>
          <div css={mainp}>
            <span css={mainh3}>
              <span css={text}>S-CON은</span> 성공회대학교 IT 경진대회 및
              소프트웨어 경진대회와 미디어컨텐츠 경진대회등 이공계열 학생들이
              참여하는 교내 대회 작품을 조금 더 쉽게 확인할 수 있도록 만들어진{" "}
              <span css={text}>경진대회 모음집</span>이라고 할 수 있습니다.
            </span>
          </div>
          <div>
            <h4 css={mainh}>
              <span css={mainh4}>S-CON 사용법</span>
            </h4>
          </div>
          <p css={mainp}>
            <span css={mainh5}>
              현재 페이지에서 <span css={text}>좌측</span>을 확인시 각{" "}
              <span css={text}>[IT] [미디어켄턴츠] [S/W 경진대회] 의 탭</span>이
              있는 것을 확인할 수 있습니다. 각 탭을 클릭 시 해당 경진대회에
              수상한 작품의 이름과 팀명을 확인할 수 있으며, 추가적으로 마음에
              드는 작품을 클릭하면 해당 작품에 대한 영상과 작품 내용을 확인할 수
              있습니다.
            </span>
          </p>
        </div>
        <div css={btnwrap}>
          <Link to="/write">
            <button css={btn}> 작성 폼으로 이동</button>
          </Link>
        </div>
        <footer css={introduce}>
          ⓒ IT융합자율학부 - 김지인, 김은정, 손창하, 한슬희
        </footer>
      </div>
    </div>
  );
